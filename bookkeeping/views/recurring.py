...
def subscription_list(request):
    """Show all active subscriptions with monthly/annual totals and a category breakdown."""
    subscriptions = (
    ...
    monthly_total = subscriptions.aggregate(total=Sum("amount"))["total"] or 0
    annual_total = monthly_total * 12

    # Category breakdown for donut chart
    by_category = (
        subscriptions.values("category__name")
    ...
    return render(
        request,
        "bookkeeping/recurring/subscription_list.html",
        {
