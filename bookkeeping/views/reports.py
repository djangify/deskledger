...
def yearly_profit_report_csv(request):
    ...
    # Currency symbol for this user's column headers
    ...
    writer.writerow(["DeskLedger Local Edition"])
    ...
    writer.writerow(["Description", f"Amount ({sym})"])
    ...
    writer.writerow(
        ["Category", f"Total ({sym})", "Number of Entries", f"Average ({sym})"]
    )
    ...
    writer.writerow([])
    writer.writerow(["Report generated by DeskLedger Local Edition"])
    writer.writerow(["https:// deskledger.uk"])
