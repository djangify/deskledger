...
urlpatterns = [
    ...
    path("expense/ocr/", expense.ocr_receipt, name="ocr_receipt"),
    # ------------------------------
    # RECURRING
    # ------------------------------
    path("recurring/", recurring.recurring_list, name="recurring_list"),
    path("recurring/subscriptions/", recurring.subscription_list, name="subscription_list"),
    ...
    path("categories/add/", category.category_create, name="category_create"),
    path("categories/<int:pk>/edit/", category.category_edit, name="category_edit"),
