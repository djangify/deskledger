...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if income_2024 > 0 or expense_2024 > 0:
            self.stdout.write(
                self.style.SUCCESS(
                    f"\n[OK] YES - Found {income_2024} income and {expense_2024} expense records in 2024"
                )
            )
        else:
            self.stdout.write(
                self.style.WARNING("\n[X] NO - No records found in calendar year 2024")
            )
        ...
        if income_tax_2023 > 0 or expense_tax_2023 > 0:
            self.stdout.write(
                self.style.SUCCESS(
                    f"\n[OK] YES - Found {income_tax_2023} income and {expense_tax_2023} expense records in tax year 2023-2024"
                )
            )
        ...
        if income_tax_2024 > 0 or expense_tax_2024 > 0:
            self.stdout.write(
                self.style.SUCCESS(
                    f"\n[OK] YES - Found {income_tax_2024} income and {expense_tax_2024} expense records in tax year 2024-2025"
                )
            )
